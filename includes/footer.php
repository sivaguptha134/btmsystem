          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood Bank Donor </span>Hospital Management System 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>Every drop counts, and your donation can bring hope and healing to those who are going through challenging times.
              So, let's come together and be the heroes that make this world a better place. Donate blood and be a lifesaver today
.</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  BloodBank,Donor & Hospital Management System
